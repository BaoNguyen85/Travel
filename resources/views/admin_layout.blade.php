...
<html>
    <head>
        ...
        <link href="{{asset ('/../resources/css/dashboard.css') }}" rel='stylesheet' type='text/css' />
            ...
            <div class="sidebar">
                ...
                <div class="nav">
                    <div class="menu">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ URL::to('/new-place') }}">
                                            <span class="text">Thêm địa danh</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/all-place') }}">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ URL::to('/new-destination') }}">
                                            <span class="text">Thêm điểm đến</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/all-destination') }}">
                                            <span class="text">Danh sách điểm đến</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/new-destination-detail') }}">
                                            <span class="text">Thêm chuỗi điểm đến</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/all-destination-detail') }}">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{  URL::to('/new-tour-type') }}">
                                            <span class="text">Thêm loại tour</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{  URL::to('/all-tour-type') }}">
                            ...
                            {{-- <li>
                                <a href="#">
                                    ...
                                    <span class="text">Quản lý thời gian</span>
                                </a>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ URL::to('/new-time') }}">
                                            <span class="text">Thêm thời gian</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/all-time') }}">
                                            <span class="text">Danh sách diễn ra</span>
                                        </a>
                                    </li>
                                </ul>
                            </li> --}}
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ URL::to('/new-tourguide') }}">
                                            <span class="text">Thêm hướng dẫn viên</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('/all-tourguide') }}">
                    ...
                    <div class="menu">
                        ...
                        <ul>
                            <li>
                                <a href="{{ URL::to('/admin-infor/'.$adminID) }}">
                                    <i class="fa-solid fa-user"></i>
                                    <span class="text">Account</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ URL::to('/information-infor/1') }}">
