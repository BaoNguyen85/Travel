...
<body>
    <nav class="nav-style" style="background-color: #ffffff" id="navBar">
        ...
        <div class="search-bar">
            <form method="post" action="{{ URL::to('/search-tour') }}">
                {{ csrf_field() }}
    ...
    @foreach($edit_profile_customer as $key => $pro)
    <form id="profileForm" method="post" action="{{ URL::to('/update-profile-customer/'.$customerID) }}" enctype="multipart/form-data" onsubmit="onSubmitForm(event)">
        {{ csrf_field() }}
    <div class="edit-profile-customer">
        ...
        <p><b>Họ tên :</b> <input type="text" value="{{ $pro->customer_name }}" name="customer_name" required></p>
        <p><b>Ngày sinh :</b> <input type="date" value="{{ $pro->customer_birth }}" name="customer_birth" required></p>
        <p><b>Email :</b> {{ $pro->customer_mail }}</p>
        <p><b>Số điện thoại :</b> <input type="text" value="{{ $pro->customer_phone }}" name="customer_phone" required></p>
        <p><b>Địa chỉ :</b> <input type="text" value="{{ $pro->customer_address }}" name="customer_address" required></p>
        <p></p>
