        ...
        <div id="carousel-stories">
            ...
            <div class="stories">
                <?php $__currentLoopData = $all_tourdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tourdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $search_tour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($tourdetail->tour_id == $tour->tour_id && $tourdetail->tour_show==0): ?>
                        <div>
...
</html><?php /**PATH D:\XAMPP\htdocs\travel\resources\views/search.blade.php ENDPATH**/ ?>