    ...
    <div class="container">
        <div class="list-container">
            ...
            <div class="right-col">
                ...
                <?php $__currentLoopData = $tourtype_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tourtype_dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <h1><?php echo e($tourtype_dt->tourtype_name); ?></h1>
                <p><?php echo $tourtype_dt->tourtype_describe; ?><br></p>
                    <?php $__currentLoopData = $all_tourdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tourdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($tourtype_dt->tourtype_id == $tour->tourtype_id && $tour->tour_id == $tourdetail->tour_id): ?>
                        <div class="house">
...
</html><?php /**PATH D:\XAMPP\htdocs\travel\resources\views/tourtype_detail.blade.php ENDPATH**/ ?>