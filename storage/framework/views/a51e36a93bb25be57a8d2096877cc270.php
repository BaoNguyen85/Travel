...
<body>
    <div class="header">
        ...
        <div class="wrapper">
            <form action="<?php echo e(URL::to ('/cus-register')); ?>" method="POST">
                ...
                <div class="register-link">
                    <a href="<?php echo e(URL::to('/login-customer-google')); ?>"><img src="<?php echo e(asset('../public/frontend/images/google.png')); ?>" style="width: 8%;padding: 4% 0" alt=""></a><p>Or <a href="<?php echo e(URL::to('/customer-login')); ?>">Đăng Nhập</a></p>
                </div>
            </form>
        </div>   
    </div>
...
</html><?php /**PATH D:\XAMPP\htdocs\travel\resources\views/customerRegister.blade.php ENDPATH**/ ?>